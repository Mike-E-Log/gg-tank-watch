...
| **Scalable oversight** | A 213-test eval harness monitors behavioral properties incl. the G1 language gate, provenance (no fabricated sources), and the corroboration gate on danger downgrades | `eval/` harness, `test_provenance.py`, `test_language_access.py` |
