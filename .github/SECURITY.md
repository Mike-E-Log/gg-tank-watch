...
- `noindex` is kept permanently by choice, not a pending gate. Attorney review (originally the launch gate) was judged unnecessary once the incident resolved and the site froze. No wide launch is planned (see [`docs/archive/DEPLOYMENT_READINESS.md`](../docs/archive/DEPLOYMENT_READINESS.md)).
